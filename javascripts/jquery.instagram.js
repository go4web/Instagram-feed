...
(function ($){
  $.fn.instagram = function (options) {
    ...
    function createPhotoElement(photo) {
      ...
      var image_url_large = photo.images.standard_resolution.url;
      ...
      var innerHtml = $('<img>')
		...
		var instaLink = $('<a>')
          .attr('target', '_blank')
          .attr('href', photo.link).html('Se på Instagram');
          	

		var hearth = $('<li class="likes">').html('<span>♥</span> ' + photo.likes.count + '')
		var comment = $('<li>').html('comments (' + photo.comments.count + ')')
		var link = $('<li class="right">').append(instaLink);
